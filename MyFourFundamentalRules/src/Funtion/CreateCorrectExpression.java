...
//        for(int i = 0; i < 10; i++){
//            String s = createExpression(10);
//            System.out.println(s);
//        }
//    }
//    private static String[] questions = new String[100];
//    private static String[] answers = new String[100];
//
...
//    public static void outCorrectExpression(int num, int in, File Exercise,File Answer) throws Exception{
...
//
//    //  循环
//        s = createExpression(in);
//
//    //  重点: 拿到表达式并判断 1、减号问题 2、/0
//        questions[0] = s;
//
//        // 做出答案,
//        //answers[0] = CorrectAnswer.answer(correctExpression);
//
//    // end 循环
//        // 3 等价
//    // 正确的表达式 写入练习文件
