...
//public class keepCorrectAnswer{
//
//    public static void main(String[] args) {
//        String expression = "1 ＋ ( 2 ÷ ( 3 × 20 ) ) = ";
//        String s = answer(expression);
//        System.out.println(s);
//    }
//
//    /**      配合正确输出的算术表达式 并 做出正确答案     */
//    private static String answer(String correctExpression) {
//        String s;
...
//        int len = 0;
//        for(int j = 0; j < charpriority.length; j++){
//            if(charpriority[j] != null){
//                len++;
//            }
//        }
...
//
//    /**       选择运算符，通分计算            */
//    public static String caculate(int[] num1,int[] num2,char c){
//        String s = "";
//        // up 分子 down 分母
...
//    public static int f(int up,int down){
//        int temp;
//        while(true) {
//            temp = down % up;
//            if (temp == 0) {
...
//            }
//        }
//        //   求运算符和下标, 如1+2-3=  oldstr: 1+3-
//        String[] oldstr = charAndIndex(temp);
//        newstr= sort(blankets, oldstr,temp);
//        return newstr;
//    }
//
//    /**      输出  str数组(下标+运算符) 内运算符 按优先级排序好的顺序, 记录下标      */
...
//    }
//
//    private static String[] sort(int[] blankets, String[] oldstr,StringBuffer expression) {
//        String[] newstr = new String[6];
...
//                while(str[j] != null){
//                    str[j] = String.valueOf(Integer.parseInt(str[j]) + blankets[0] + 1);
//                    j += 2;
//                }
...
//                // 找到,未进行排序的 运算符下标
//                x:
//                for (i = 0; i < oldstr.length; i += 2) {
//                    for (int x = 0; newstr[x] != null; x++) {
//                        if (newstr[x].equals(oldstr[i])) {
//                            continue x;
//                        }
//                    }
//                    //  temp 实际长度为 t
...
//                    temp[t++] = oldstr[i + 1];
//                }
//                // temp 放的是, 还没进行 排序的 运算符以及其下标,重新出来的temp实际长度为 t/2
//                temp = blanketsJudge(temp);
//                for(j = 0, i = 0; str[j] != null; j++){
//                    i++;
//                }
//                for (i = i/2,p = 0; temp[p] != null; p++) {
//                    newstr[i++] = temp[p];
//                }
//                return newstr;
//            }
...
//                j = 0;
//                while(str2[j] != null){
//                    str2[j] = String.valueOf(Integer.parseInt(str2[j])+blankets[2]+1);
//                    j+=2;
//                }
//                //  对 str 的运算符做优先级排序，输出运算符下标
//                str1 = blanketsJudge(str1);
//                str2 = blanketsJudge(str2);
...
//                }
//                x:
//                for (p = 0; p < oldstr.length; p += 2) {
//                    for (int x = 0; x < 2; x++) {
//                        if (newstr[x].equals(oldstr[p])) {
//                            continue x;
//                        }
//                    }
//                    //  temp 实际长度为 t
